        ...
        return cache.getResponse(url, function (err, cachedResponse) {
            ...
            request('GET', url, {
                ...
                if (res.statusCode === 304 && cachedResponse) { // Not Modified
                    // prevent leakage of file handles
                    res.body.resume();
                    var response = new Response(cachedResponse.statusCode, cachedResponse.headers, cachedResponse.body, url);
                ...
                if (options.canCache ? options.canCache(res, canCache) : canCache) {
                    ...
                    res.body.on('end', function () { cachedResponseBody_1.end(); resultResponseBody_1.end(); });
